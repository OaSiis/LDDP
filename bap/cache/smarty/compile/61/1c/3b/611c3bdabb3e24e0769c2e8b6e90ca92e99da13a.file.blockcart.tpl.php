<?php /* Smarty version Smarty-3.1.19, created on 2015-11-14 13:23:43
         compiled from "/home/activeciuk/www/bap/themes/default-bootstrap/modules/blockcart/blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1597971967564727cf132851-16445207%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '611c3bdabb3e24e0769c2e8b6e90ca92e99da13a' => 
    array (
      0 => '/home/activeciuk/www/bap/themes/default-bootstrap/modules/blockcart/blockcart.tpl',
      1 => 1447503764,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1597971967564727cf132851-16445207',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_564727cf5720a8_60700784',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_564727cf5720a8_60700784')) {function content_564727cf5720a8_60700784($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home/activeciuk/www/bap/tools/smarty/plugins/modifier.replace.php';
if (!is_callable('smarty_function_counter')) include '/home/activeciuk/www/bap/tools/smarty/plugins/function.counter.php';
?>
<!-- MODULE Block cart -->
...
<?php $_tmp17=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&id_product=".$_tmp15."&ipa=".$_tmp16."&id_address_delivery=".$_tmp17."&token=".((string)$_smarty_tpl->tpl_vars['static_token']->value)), ENT_QUOTES, 'UTF-8', true);?>
...
<?php $_tmp19=ob_get_clean();?><?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['id_customization']->value);?>
<?php $_tmp20=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&id_product=".$_tmp18."&ipa=".$_tmp19."&id_customization=".$_tmp20."&token=".((string)$_smarty_tpl->tpl_vars['static_token']->value)), ENT_QUOTES, 'UTF-8', true);?>
" rel="nofollow">&nbsp;</a>
													</div>
