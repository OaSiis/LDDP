<?php /* Smarty version Smarty-3.1.19, created on 2015-11-14 13:23:52
         compiled from "/home/activeciuk/www/bap/themes/default-bootstrap/order-steps.tpl" */ ?>
<?php /*%%SmartyHeaderCode:667867793564727d8e137c2-43066309%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '31fd7758841b1e6a5518cbe973bca1fbd04a3720' => 
    array (
      0 => '/home/activeciuk/www/bap/themes/default-bootstrap/order-steps.tpl',
      1 => 1447503759,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '667867793564727d8e137c2-43066309',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_564727d8f00cb5_71595123',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_564727d8f00cb5_71595123')) {function content_564727d8f00cb5_71595123($_smarty_tpl) {?>
...
">
	...
	<li class="<?php if ($_smarty_tpl->tpl_vars['current_step']->value=='shipping') {?>step_current<?php } else { ?><?php if ($_smarty_tpl->tpl_vars['current_step']->value=='payment') {?>step_done step_done_last<?php } else { ?>step_todo<?php }?><?php }?> four">
		...
		<a href="<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['multi_shipping']->value) {?><?php echo "&multi-shipping=";?><?php echo (string)$_smarty_tpl->tpl_vars['multi_shipping']->value;?><?php }?><?php $_tmp50=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,((string)Smarty::$_smarty_vars['capture']['url_back'])."&step=2".$_tmp50), ENT_QUOTES, 'UTF-8', true);?>
">
