<?php /* Smarty version Smarty-3.1.19, created on 2015-11-14 13:23:46
         compiled from "/home/activeciuk/www/bap/themes/default-bootstrap/shopping-cart-product-line.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1216066455564727d2504f06-33946354%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5854cd64c2f57f30f1cc6fe866bfef5859fcf869' => 
    array (
      0 => '/home/activeciuk/www/bap/themes/default-bootstrap/shopping-cart-product-line.tpl',
      1 => 1447503759,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1216066455564727d2504f06-33946354',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_564727d299ba88_63822374',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_564727d299ba88_63822374')) {function content_564727d299ba88_63822374($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home/activeciuk/www/bap/tools/smarty/plugins/modifier.replace.php';
if (!is_callable('smarty_modifier_regex_replace')) include '/home/activeciuk/www/bap/tools/smarty/plugins/modifier.regex_replace.php';
?>
...
<?php $_tmp31=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add=1&amp;id_product=".$_tmp29."&amp;ipa=".$_tmp30."&amp;id_address_delivery=".$_tmp31."&amp;op=down&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
...
<?php $_tmp34=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add=1&amp;id_product=".$_tmp32."&amp;ipa=".$_tmp33."&amp;id_address_delivery=".$_tmp34."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
...
<?php $_tmp37=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&amp;id_product=".$_tmp35."&amp;ipa=".$_tmp36."&amp;id_address_delivery=".$_tmp37."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
