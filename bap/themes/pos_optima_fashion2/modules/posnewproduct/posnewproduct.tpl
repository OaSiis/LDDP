	...
	<div class="flexslider carousel">
		<ul class="bxslider">			
			{foreach from=$products item=product name=posNewProducts}
				<li class="newproductslider-item ajax_block_product {if $smarty.foreach.posFeatureProducts.first}first_item{elseif $smarty.foreach.posFeatureProducts.last}last_item{else}item{/if}">
