...
<!-- MODULE Block cart -->
	...
	<div class="shopping_cart">
		<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
			<div class="bg-qty">
			<span class="ajax_cart_quantity{if $cart_qties == 0} unvisible{/if}">{if $cart_qties<10}0{/if}{$cart_qties}</span>			
			...
			<span class="ajax_cart_no_product{if $cart_qties > 0} unvisible{/if}" >{l s='00' mod='blockcart'}</span>
